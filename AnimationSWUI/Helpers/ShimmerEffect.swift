            ...
            GeometryReader {
              ...
              Rectangle()
                ...
                .mask {
                  Rectangle()
                    .fill(
                      .linearGradient(colors: [.white.opacity(0), config.highlight.opacity(config.highLightOpasity),.white.opacity(0)], startPoint: .top, endPoint: .bottom))
...
struct ShimmerConfig {
  ...
  var highlight: Color
  var blur: CGFloat = 0
  var highLightOpasity: CGFloat = 1
  var speed: CGFloat = 2
}
